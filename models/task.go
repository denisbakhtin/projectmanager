...
type Task struct {
	...
	ProjectID     uint           `json:"project_id" gorm:"index" valid:"required"`
	ProjectUserID uint           `json:"project_user_id" gorm:"index" valid:"required"`
	TaskStepID    uint           `json:"task_step_id" gorm:"index" valid:"required"`
