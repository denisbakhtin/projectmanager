...
export default function Task() {
    ...
    function setStepID(step_id) {
        task.task_step_id = step_id
    }
    function setProjectUserID(project_user_id) {
        task.project_user_id = project_user_id
    }
    ...
    function getProjectUsers() {
        return service.getProjectUsers(task.project_id)
